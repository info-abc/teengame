...
?>
@extends('site.layout.default_pc', array('seoMeta' => $seoMeta, 'seoImage' => FOLDER_SEO_PARENT . '/' . $categoryParent->id, 'ogUrl' => url($categoryParent->slug)))
...
<?php
	$games = CommonGame::boxGameByCategoryParent($categoryParent, 2);
