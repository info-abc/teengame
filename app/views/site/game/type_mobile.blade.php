...
?>
@extends('site.layout.default_mobile', array('seoMeta' => $seoMeta, 'seoImage' => FOLDER_SEO_GAMETYPE . '/' . $type->id, 'ogUrl' => url($type->slug.'-games')))
...
<?php
	$games = CommonGame::boxGameByType($type, 1);
				...
				<div class="swiper-slide boxgame">
					...
					?>
						@foreach($listGame as $game)
							@include('site.game.gameitem_cronjob', array('game' => $game, 'slug' => $type->slug, 'device' => 1))
						@endforeach
					</div>
				</div>
			@endfor
