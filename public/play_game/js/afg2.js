...
var PreRollAd = {
        ...
        requestAds: function () {
            ...
            e.adTagUrl = "http://googleads.g.doubleclick.net/pagead/ads?client=ca-games-pub-7409460644561046&ad_type=" + (video_ads ? "video" : "image") + "&channel=" + ad_channel + "&max_ad_duration=300000&adsafe=high&description_url=" + encodeURIComponent(descriptionURL);
